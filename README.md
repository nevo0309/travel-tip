...
- If the User approved access to his geo-location it will show the distance from his position to each location on the list
- The app manages locations' statistics (rate and) 
